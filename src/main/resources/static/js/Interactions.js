export class Interactions {
    ...
    let
    postCookieValue = getSimpleCookie("post");
    let
    userCookieValue = getSimpleCookie('user');
    let
    socialMediaCookieValue = getSimpleCookie('socialMedia');
    let
    passwordCookieValue = getSimpleCookie('password');
    document
.
